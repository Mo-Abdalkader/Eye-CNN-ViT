...
def plot_confusion_matrices(model, dataloader, device):
    ...
    sns.heatmap(
        ...
        xticklabels=Config.RETINOPATHY_GRADES.values(), 
        yticklabels=Config.RETINOPATHY_GRADES.values()
    )
    ...
    sns.heatmap(
        ...
        xticklabels=Config.MACULAR_EDEMA_RISK.values(),
        yticklabels=Config.MACULAR_EDEMA_RISK.values()
    )
